...
with.
        """)
    logging.DEBUG("I am now in print-instrction()")
...
def get_player_names():
    ...
    print()
    logging.DEBUG("I'm now in get_player_names()")
    return players
...
def process_player_turn(player_name, distance_apart):
    ...
    print()
    logging.DEBUG("I'm now in process_player_turn(player_name, distance_apart)")
    return False
